...
export const Footer = () => {
  return (
    <footer className="min-h-sm flex border-t border-body-300 bg-body-100 pt-2 text-center text-body-800 dark:border-body-700 dark:bg-neutral-950 dark:text-body-300">
      <DevInformation />
    </footer>
  );
};
