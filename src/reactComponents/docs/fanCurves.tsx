...
const rpmMode: DocSection = {
  ...
  render: () => (
    <p>
      All fan curves can be used in RPM mode from their <SmallIcon icon={icons.threeDot} className="inline align-middle" /> menu. Instead of outputting a % value, it will output a target RPM
